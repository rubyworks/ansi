...
The ANSI::String class is a very sophistacted implementation
of Ruby's standard String class, but one that can handle
ANSI codes seemlessly.
...
Some of the most difficult methods to reimplement were the 
substitution methods such as #sub and #gsub. They are still
somewhat more limited than the orignal string methods, but
